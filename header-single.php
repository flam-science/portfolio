...
<head>
    ...
    <?php if (is_singular('post_works') || is_singular('post_youtube')) : ?>
        <?php
        // カスタム投稿タイプ 'post_works' または 'post_youtube' のカスタムmeta情報を取得
        ...
        ?>
        <title><?php echo esc_html($meta_title ? $meta_title : get_the_title() . ' | ' . get_bloginfo('name')); ?></title>
        <meta name="description" content="<?php echo esc_attr($meta_description ? $meta_description : strip_tags(get_the_excerpt())); ?>">
    <?php elseif (is_page() || is_single()) : ?>
        <?php
        // 通常のページや投稿のカスタムmeta情報を取得
        $meta_title = get_post_meta(get_the_ID(), '_custom_meta_title', true);
        $meta_description = get_post_meta(get_the_ID(), '_custom_meta_description', true);
        ?>
        <title>
            <?php 
            // Meta Title が設定されていればそれを、なければサイトタイトルとページタイトルを表示
            echo esc_html($meta_title ? $meta_title : wp_title('|', false, 'right') . get_bloginfo('name')); 
            ?>
        </title>
        <meta name="description" content="<?php echo esc_attr($meta_description ? $meta_description : get_bloginfo('description')); ?>">
    <?php else : ?>
    ...
    <meta property="og:description" content="<?php echo esc_attr($meta_description ? $meta_description : get_bloginfo('description')); ?>">
...
<body class="body__wrapper">
    ...
    <header class="header">
        <div class="header__wrapper">
            ...
            <a href="<?php echo esc_url(home_url('/')); ?>" class="header__left inView">
                <img src="<?php echo esc_url(get_template_directory_uri() . '/image/logo/header-logo.svg'); ?>" alt="yuzu design" width="200" height="100" class="header__logo hover" loading="lazy">
            </a>
                                ...
                                <li class="hamburger__main--contents">
                                    ...
                                    <div class="hamburger__works">
                                        <a href="<?php echo esc_url(home_url('works')); ?>" class="hamburger__main--item hover">
                                            ...
                                            <img src="<?php echo esc_url(get_template_directory_uri() . '/image/icon/material-laptop-mac.png'); ?>" alt="制作物イメージ" class="hamburger__icon--image" width="16" height="16" loading="lazy">
                                            </i>
    ...
    <i class="hamburger__icon">
        <img src="<?php echo esc_url(get_template_directory_uri() . '/image/icon/core-vector.png'); ?>" alt="デザインイメージ" class="hamburger__icon--image" width="16" height="16" loading="lazy">
    </i>
...
<a href="<?php echo esc_url(get_category_link(get_category_by_slug('coding')->term_id)); ?>" class="hamburger__main--item hover">
    <i class="hamburger__icon">
        <img src="<?php echo esc_url(get_template_directory_uri() . '/image/icon/material-code.png'); ?>" alt="コーディングイメージ" class="hamburger__icon--image" width="16" height="16" loading="lazy">
    </i>
    <p class="hamburger__icon--text">コーディング</p>
                                ...
                                <li class="hamburger__main--contents">
                                    ...
                                    <div class="hamburger__youtube">
                                        <a href="<?php echo esc_url(home_url('youtube')); ?>" class="hamburger__main--item hover">
                                            <i class="hamburger__icon">
                                            <img src="<?php echo esc_url(get_template_directory_uri() . '/image/icon/core-movie.png'); ?>" alt="動画イメージ" class="hamburger__icon--image" width="16" height="16" loading="lazy">
                                            </i>
                                        ...
                                        <a href="https://www.youtube.com/channel/UCEbjeS64XQiB4hD_77pAtdQ" class="hamburger__main--item hover" target="_blank">
                                            <i class="hamburger__icon">
                                            <img src="<?php echo esc_url(get_template_directory_uri() . '/image/icon/akar-airplay-video.png'); ?>" alt="チャンネルイメージ" class="hamburger__icon--image" width="16" height="16" loading="lazy">
                                            </i>
                                ...
                                <li class="hamburger__sns--contents">
                                    <a href="https://www.youtube.com/channel/UCEbjeS64XQiB4hD_77pAtdQ" class="hamburger__sns--item hover" target="_blank">
                                        <i class="hamburger__sns--icon">
                                            <img src="<?php echo esc_url(get_template_directory_uri() . '/image/icon/akar-youtube-fill.png'); ?>" alt="youtubeはこちら" class="hamburger__sns--image" width="16" height="16" loading="lazy">
                                        </i>
                                    </a>
                                    <a href="https://x.com/flam0309" class="hamburger__sns--item hover" target="_blank">
                                        <i class="hamburger__sns--icon">
                                            <img src="<?php echo esc_url(get_template_directory_uri() . '/image/icon/simple-x.png'); ?>" alt="Xはこちら" class="hamburger__sns--image" width="16" height="16" loading="lazy">
                                        </i>
                                    </a>
                                </li>
                            </ul>
                            <div class="hamburger__news">
                                ...
                                <img src="<?php echo esc_url(get_template_directory_uri() . '/image/icon/material-fiber-new.png'); ?>" alt="新着記事" class="hamburger__news--icon" width="18" height="18" loading="lazy">
