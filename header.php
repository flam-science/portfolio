...
<head>
    ...
    <!-- OGP設定 -->
    <meta property="og:title" content="<?php if (is_front_page()) { bloginfo('name'); } else { echo esc_html($meta_title ? $meta_title : wp_title('|', false, 'right') . get_bloginfo('name')); } ?>">
    <meta property="og:description" content="<?php if (is_front_page()) { bloginfo('description'); } else { echo esc_attr($meta_description ? $meta_description : strip_tags(get_the_excerpt())); } ?>">
