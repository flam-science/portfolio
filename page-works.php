    ...
    while ($works_query->have_posts()) : $works_query->the_post(); ?>
        ...
        <a href="<?php the_permalink(); ?>" class="works__main--contents inView hover">
            <div class="works__main--thumbnail-wrapper">
                ...
                <?php else : ?>
                    <!-- サムネイルがない場合の代替画像 -->
                    <img src="<?php echo esc_url(get_template_directory_uri() . '/image/no-image/no-image.webp'); ?>" alt="No Image" width="528" height="281" class="works__main--thumbnail">
                <?php endif; ?>
            </div>
